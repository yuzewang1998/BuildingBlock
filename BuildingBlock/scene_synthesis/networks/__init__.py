...
from .diffusion_scene_layout_ddpm import (
    DiffusionSceneLayout_DDPM,
    train_on_batch as train_on_batch_diffusion_scene_layout_ddpm,
    train_on_batch_ddp as train_on_batch_diffusion_scene_layout_ddpm_ddp,
...
def build_network(
    ...
    if network_type == "diffusion_scene_layout_ddpm":
        ...
        if ddp:
            train_on_batch = train_on_batch_diffusion_scene_layout_ddpm_ddp
