...
if __name__ == "__main__":
    ...
    path_to_test_real = "/tmp/test_real"  # /tmp/test_real
    ...
    path_to_test_fake = "/tmp/test_fake"  # /tmp/test_fake/
    ...
    # Downsample points
    path_to_test_real_sample = "/tmp/test_real_sample"  # /tmp/test_real
    if not os.path.exists(path_to_test_real_sample):
        os.makedirs(path_to_test_real_sample)

    path_to_test_fake_sample = "/tmp/test_fake_sample"  # /tmp/test_fake/
