...
def main(argv):
    ...
    path_to_test_real = "/tmp/test_real"  # "/cluster/balrog/jtang/ATISS_exps/test_real/" # /tmp/test_real
    ...
    path_to_test_fake = "/tmp/test_fake/"  # "/cluster/balrog/jtang/ATISS_exps/test_fake/" #/tmp/test_fake/
    ...
    fid_score = fid.compute_fid(
        path_to_test_real, path_to_test_fake, device=torch.device("cuda")
    )
